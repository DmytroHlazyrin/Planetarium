...
from shows.models import ShowSession, Ticket, Reservation
from shows.serializers import TicketListSerializer
...
Ticket_URL = reverse("shows:ticket-list")
...
class TicketFilteringApiTests(TestCase):
    ...
    def test_filter_ticket_reservation_user(self):
        ...
        user2 = user_test(
            email="user2@email.com", password="defaultpassword122"
        )
        """Ticket object 2"""
        ...
        """Ticket object 3"""
        user3 = user_test(email="user3@email.com", password="defaultpassword122")
...
class TicketModelsTests(TestCase):
    ...
    def test_show_theme_str(self):
        ...
        self.assertEqual(
            ...
            f"row: {ticker_object.row}, seat: {ticker_object.seat}, "
            f"show_session: {ticker_object.show_session}, "
            f"reservation: {ticker_object.reservation.user}",
        )
...
class ReservationTest(TestCase):
    def setUp(self):
        self.client = APIClient()
        self.user = user_test()
        self.user_1 = user_test(email="bad@user.com", password="bad122")
