...
class AuthenticatedAstronomyShowApiTests(TestCase):
    ...
    def test_list_astronomy_show(self):
        obj1 = sample_astronomy_show(title="test", description="description")
        obj1.show_theme.add(sample_show_theme(name="Teste Theme1"))
        obj2 = sample_astronomy_show(title="test2", description="description")
    ...
    def test_not_create_astronomy_show(self):
        payload = {"name": "Astronomy Show Test"}
...
class AstronomyShowFilteringApiTests(TestCase):
    ...
    def test_filter_astronomy_show_title(self):
        ...
        astronomy_show_object_1.show_theme.add(
            sample_show_theme(name="Sample Theme 1")
        )
    ...
    def test_filter_astronomy_show_show_theme(self):
        ...
        astronomy_show_object_3.show_theme.add(
            sample_show_theme(name="No Match")
        )
...
class AstronomyShowValidation(TestCase):
    ...
    def test_validate_astronomy_show_name_models(self):
        with self.assertRaises(IntegrityError):
            ...
            astronomy_show_object_2.show_theme.add(
                sample_show_theme(name="Sample Theme")
            )
            astronomy_show_object_3 = sample_astronomy_show(
                title="New Astronomy Show 1",
                description="New description 1",
...
class ShowThemeModelsTests(TestCase):
    ...
    def test_show_theme_str(self):
        astronomy_show_object_1 = sample_astronomy_show()
        self.assertEqual(
            astronomy_show_object_1.title.__str__(), "Sample Astronomy Show"
        )
        self.assertEqual(
            astronomy_show_object_1.__str__(),
            f"name_show: {astronomy_show_object_1.title}, description: {astronomy_show_object_1.description}",
        )
